...
abstract class AppLocalizations {
  ...
  /// No description provided for @flightSites.
  ///
  /// In en, this message translates to:
  /// **'Flight Sites'**
  String get flightSites;
  ...
  /// No description provided for @lesson_marked_complete.
  ///
  /// In en, this message translates to:
  /// **'Lesson marked as complete!'**
  String get lesson_marked_complete;

  /// No description provided for @lesson_marked_incomplete.
  ///
  /// In en, this message translates to:
